...
const Chat = () => {
    ...
    return (
        <div className='bg-white p-3 rounded-md font-thai'>
            <title>แชท - Micro Agrotec</title>
        ...
        <span>{m.message}</span>
                ...
                <div className='flex p-2 justify-between items-center w-full'>
                    ...
                    <div className='border h-[40px] p-0 ml-2 w-[calc(100%-90px)] rounded-full relative'>
                        <input value={text} onChange={(e) => setText(e.target.value)} type="text" placeholder='เขียนข้อความ' className='w-full rounded-full h-full outline-none p-3' />
