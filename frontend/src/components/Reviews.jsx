...
const Reviews = ({product}) => {
    ...
    <div className='flex gap-10 md-lg:flex-col'>
        <div className='flex flex-col gap-2 justify-start items-start py-4'>
            ...
            <p className='text-sm text-slate-600'>({totalReview}) รีวิว</p>
        </div>
    ...
    <h2 className='text-slate-600 text-xl font-bold py-5'>รีวิวสินค้า({totalReview})</h2>
    ...
    <div>
        {
            userInfo ? <div className='flex flex-col gap-3'>
                ...
                <div className='mt-2'>
            <button className='py-1 px-5 bg-blue-900 text-white rounded-sm'>ส่ง</button>
                </div>
                ...
                <Link to='/login' className='py-1 px-5 bg-red-500 text-white rounded-sm'> โปรดเข้าสู่ระบบก่อน </Link>
            </div>
        }
