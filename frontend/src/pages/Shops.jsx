...
const Shops = () => {
    ...
    return (
        <div className='font-thai'>
            <title>ร้านค้า - Micro Agrotec</title>
           <Header/>
           <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                <div className='w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    <div className='flex flex-col justify-center gap-1 items-center h-full w-full text-white'>
                <h2 className='text-3xl font-bold'>หน้าร้านค้า</h2>
           ...
           <section className='py-16'>
            ...
            <div className={` md:block hidden ${!filter ? 'mb-6' : 'mb-0'} `}>
                <button onClick={() => setFilter(!filter)} className='text-center w-full py-2 px-3 bg-indigo-500 text-white'>ตัวกรองสินค้า</button> 
            </div>
            <div className='w-full flex flex-wrap'>
                <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0' } `}>
                    <h2 className='text-3xl font-bold mb-3 text-slate-600'>หมวดหมู่สินค้า</h2>
        ...
        <div className='py-2 flex flex-col gap-5'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>ราคา</h2>
             ...
             <Range
                ...
                renderThumb={({ props }) => (
                    <div className='w-[15px] h-[15px] bg-[#053594] rounded-full' {...props} />
         ...
         <div className='py-3 flex flex-col gap-4'>
            <h2 className='text-3xl font-bold mb-3 text-slate-600'>คะแนน</h2>
        ...
        <Products title='สินค้าใหม่ล่าสุด'  products={latest_product} />
            </div> 
          </div>
        ...
        <div className='w-9/12 md-lg:w-8/12 md:w-full'>
            <div className='pl-8 md:pl-0'>
                <div className='py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border'>
                    <h2 className='text-lg font-medium text-slate-600'>({totalProduct}) สินค้า </h2>
