...
const handleDelete = (id) => {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <div className="flex lg:hidden justify-between items-center mb-5 p-4 bg-[#ffffff] rounded-md shadow-xl">
        <h1 className="text-[#111827] font-semibold text-lg">Category</h1>
        <button
          onClick={() => setShow(true)}
          className="bg-blue-900 shadow-lg hover:shadow-blue-500/40 px-4 py-2 cursor-pointer text-white rounded-sm text-sm"
        >
          Add
        </button>
      </div>
      ...
      <div className="flex flex-wrap w-full">
        ...
        >
          <div className="w-full pl-5">
            <div className="bg-[#ffffff] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#111827] shadow-xl">
              <div className="flex justify-between items-center mb-4">
              <h1 className='text-[#363636] font-semibold text-xl mb-4 w-full text-center '> { isEdit ? 'Edit Category' : 'Add Category' } </h1>
              ...
              <form onSubmit={addOrUpdateCategory}>
                ...
                <div>
                  <label
                    className="flex justify-center items-center flex-col h-[238px] cursor-pointer border border-dashed hover:border-sky-500 w-full border-[#111827]"
                    htmlFor="image"
                  >
                    {
                  ...
                  />
                  <div className="mt-4">
                  <button disabled={loader ? true : false} className="bg-blue-900 w-full hover:shadow-blue-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3">
            {
