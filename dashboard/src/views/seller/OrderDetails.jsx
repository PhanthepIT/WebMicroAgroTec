    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4 bg-[#ffffff] rounded-md shadow-xl">
        <div className="flex justify-between items-center p-4">
            <h2 className="text-xl text-[#111827]">Order Details</h2>
            <select onChange={status_update} value={status} name="" id="" className="px-4 py-2 focus:border-sky-500 outline-none bg-[#1f2937] border border-slate-700 rounded-md text-[#ffffff]">
        ...
        <div className="p-4">
            ...
            <div className="flex flex-wrap">
                <div className="w-[30%]">
                    <div className="pr-3 text-[#111827] text-lg">
                        ...
                        <span>Price : {order.price} Baht</span> 

         {
            order?.products?.map((p,i) => <div key={i} className='mt-4 flex flex-col gap-4 bg-[#f3f3f3] rounded-md shadow-lg'>
