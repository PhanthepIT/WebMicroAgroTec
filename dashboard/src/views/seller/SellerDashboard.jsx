...
const SellerDashboard = () => {
    ...
    return (
        <div className='px-2 md:px-7 py-5'>
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#ffffff] rounded-md gap-3 shadow-xl'>
                    ...
                    <FaCartShopping className='text-[#ffedd5] shadow-lg'/>
                    </div>
                </div>
            ...
            <div className='w-full flex flex-wrap mt-7'>
                <div className='w-full lg:w-7/12 lg:pr-3'>
                    <div className='w-full bg-[#ffffff] p-4 rounded-md shadow-2xl'>
                        <Chart options={state.options} series={state.series} type='bar' height={350}/>
                    </div>
                </div>

                <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-[#ffffff] p-4 rounded-md text-[#111827] shadow-2xl'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-lg text-[#111827] pb-3'>Recent Customer Message</h2>
                            <Link to='/seller/dashboard/chat-customer' className='font-semibold text-sm text-[#111827]'>View All</Link>
                        </div>
        ...
        <div className='flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] bg-[#4b5563] rounded-full z-10'>
        {
        ...
        <div className='p-3 bg-gray-200 rounded-lg border border-slate-600 shadow-sm'>
    ...
    <time className='mb-1 text-sm font-normal sm:order-last sm:mb-0'> {moment(m.createdAt).startOf('hour').fromNow()}</time>
        ...
        <div className='p-2 text-xs font-normal bg-slate-200 rounded-lg border border-slate-800'>
            {m.message}
        </div>
        </div>
    </li>)
            ...
            <div className='w-full p-4 bg-[#ffffff] rounded-md mt-6 shadow-2xl'>
                <div className='flex justify-between items-center'>
                    <h2 className='font-semibold text-lg text-[#111827] pb-3'>Recent Orders</h2>
                    <Link to='/seller/dashboard/orders' className='font-semibold text-sm text-[#111827]'>View All</Link>
                </div>
                        ...
                        <tbody>
                            {
                                ...
                                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'><Link to={`/seller/dashboard/order/details/${d._id}`}>View</Link></td>
                            </tr>
                                )
                            }
                        </tbody>
