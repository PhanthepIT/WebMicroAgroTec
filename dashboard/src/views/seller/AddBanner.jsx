    ...
    <div className='px-2 lg:px-7 pt-5'>
...

        {
            !banner && <div>
                <form onSubmit={add}>
         <div className='mb-4'>
            <label className='flex justify-center items-center flex-col h-[180px] cursor-pointer border border-dashed hover:border-blue-500 w-full text-black' htmlFor="image">
            ...
            <button disabled={loader ? true : false}  className='bg-blue-900 w-[280px] hover:shadow-blue-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
            {
...
<form onSubmit={update}>
         <div className='mb-4'>
            <label className='flex justify-center items-center flex-col h-[180px] cursor-pointer border border-dashed hover:border-sky-500 w-full text-white' htmlFor="image">
                <span className='text-4xl'><FaRegImage /></span>
                <span>Select Banner Image </span>
            </label>
            <input required onChange={imageHandle} className='hidden' type="file" id='image' />
            ...
            <button disabled={loader ? true : false}  className='bg-sky-500 w-[280px] hover:shadow-sky-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
            {
