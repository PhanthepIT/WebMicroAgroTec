  ...
  return (
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full flex flex-wrap">
        ...
        <div className="w-full p-4 bg-[#ffffff] rounded-md text-[#111827] shadow-xl">
            <div className="flex justify-center items-center py-3">
                {
                    ...
                    </label> : <label className="flex justify-center items-center flex-col h-[150px] w-[200px] cursor-pointer border border-dashed hover:border-sky-500 border-[#111827] relative" htmlFor="img">
                    <span><BsImages /></span>
            ...
            <div className="px-0 md:px-5 py-2">
                <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative text-white">
        ...
        userInfo.payment === 'active' ? <span className='bg-red-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded'>{userInfo.payment}</span> : <span onClick={()=> dispatch(create_stripe_connect_account())}  className='bg-blue-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded'>Click Active</span>
            ...
            <div className="px-0 md:px-5 py-2">
                ...
                value={state.shopName} onChange={inputHandle}
                  className="px-4 py-2 focus:border-sky-200 outline-none bg-[#f0f9ff] border border-slate-700 rounded-md text-[#111827]"
                  type="text"
                  name="shopName"
                  id="Shop"
              ...
              <button disabled={loader ? true : false}  className='bg-red-500 w-[200px] hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
            {
               loader ? <PropagateLoader color='#fff' cssOverride={overrideStyle} /> : 'Save Changes'
                    ...
                    </form> : <div className="flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative text-white">
                    {/*<span className="p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer"><FaRegEdit /></span>*/}
                    <div className="flex gap-2">
                        <span>Shop Name : </span>
        ...
        <div className="w-full pl-0 md:pl-7 mt-6 md:mt-0 "> 
            <div className="bg-[#ffffff] rounded-md text-[#111827] p-4 shadow-xl">
                <h1 className="text-[] text-lg mb-3 font-semibold">Change Password</h1>
...
<input
  className="px-4 py-2 focus:border-blue-500 outline-none bg-[#ffffff] border border-slate-700 rounded-md text-[#111827]"
  type="email"
  name="email"
  id="email"
...
<button disabled={loader} className="bg-blue-900  hover:shadow-blue-500/40 hover:shadow-md text-white rounded-md px-7 py-2 my-2">
