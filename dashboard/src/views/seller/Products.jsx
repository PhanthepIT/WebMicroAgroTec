...
const Products = () => {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
        <h1 className="text-[#111827] font-semibold text-lg mb-3">All Products</h1>
      <div className="w-full p-4 bg-[#ffffff] rounded-md shadow-xl">
        ...
        <div className="relative overflow-x-auto mt-5">
              <table className="w-full text-sm text-left text-[#111827]">
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{d.price} Baht</td>
        ...
        <Link to={`/seller/dashboard/add-banner/${d._id}`} className='p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'> <LuImageMinus /> </Link> 
